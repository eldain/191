...
<main class="mdl-layout__content content-background flex">
	...
	<div class="twitter-card card bg-darker-grey w3 h5 flex-auto ma4 br2 shadow-2 pointer hover-bg-dark-gray">
		...
		<div class="white f3 ma3 mt4"><i class="material-icons txt-gold pr3">group</i><span id="twitter-followers">-</span> total followers</div>
	...
	<div class="ig-card card bg-darker-grey w3 h5 flex-auto ma4 br2 shadow-2 pointer hover-bg-dark-gray">
		...
		<div class="white f3 ma3 mt4"><i class="material-icons txt-gold pr3">group</i><span id="ig-followers">-</span> total followers</div>
