...
<main class="mdl-layout__content content-background flex">
	<div class="card bg-darker-grey w3 h5 flex-auto ma4 br2 shadow-2">
		...
		<div class="white f3 ma3 mt4"><i class="material-icons txt-gold pr3">favorite</i><span id="fb-reactions">-</span> reactions</div>
		<div class="white f3 ma3"><i class="material-icons txt-gold pr3">comment</i><span id="fb-comments">-</span> comments</div>
		<div class="white f3 ma3"><i class="material-icons txt-gold pr3">thumb_up</i><span id="fb-views">-</span> total page likes</div>
		<a class="link txt-gold ma3 pointer" href="/facebook">Across <span id="fb-posts">-</span> posts in <span id="fb-time-frame">-</span> days</a>
	</div>
